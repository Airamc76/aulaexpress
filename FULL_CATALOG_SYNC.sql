...
-- ===============================================================
-- Este script:
-- 1. Inserta o actualiza todos los 40 cursos.
-- 2. Asegura que el precio sea $5000 para todos.
-- 3. Usa imágenes de alta calidad y verificadas.
-- 4. Corrige el nivel a 'Básico' para evitar errores de restricción.
...
-- 8. Programación (100 Libros Ciber) - IMAGEN NUEVA
(
...
-- 10. Negocios (ChatGPT) - IMAGEN NUEVA
(
...
-- 12. Diseño (Gráfico Completo) - IMAGEN NUEVA
(
...
-- 15. Programación (C) - IMAGEN NUEVA
(
...
-- 23. Desarrollo Personal (Tesis) - IMAGEN NUEVA
(
...
-- 38. Desarrollo Personal (Gramática) - IMAGEN NUEVA
(
...
-- 39. Desarrollo Personal (Audiolibros) - IMAGEN NUEVA
(
