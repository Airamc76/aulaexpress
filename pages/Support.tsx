...
const Support: React.FC = () => {
  ...
  const handleSendTelegram = () => {
    ...
    const baseUrl = "https://t.me/AulaExpressSoporteBot";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
            ...
            <a
              ...
              className="bg-sky-500 text-white px-8 py-3 rounded-xl font-bold hover:bg-sky-600 transition-colors shadow-lg shadow-sky-100"
            >
              Chatear en Telegram
            </a>
          </div>
        ...
        <div className="mt-16 bg-slate-900 rounded-[2.5rem] p-10 lg:p-16 text-white text-center relative overflow-hidden">
          ...
          <div className="max-w-md mx-auto relative z-10">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 bg-indigo-600 p-3 rounded-xl hover:bg-indigo-700 transition-colors"
            >
