-- ===============================================================
-- SINCRONIZACIÓN FINAL DEL CATÁLOGO (V3 - REPARACIÓN DE FOTOS)
-- ===============================================================
-- Este script:
-- 1. Inserta TODOS los 41 cursos.
-- 2. Fija el precio en $5000 para todos.
-- 3. Usa imágenes estables y verificadas para los cursos problemáticos.
-- 4. Corrige el nivel a 'Básico'.
...
-- 3. Diseño (CapCut) - FOTO REPARADA V3
(
...
-- 10. Negocios (ChatGPT) - FOTO REPARADA V3
(
...
-- 12. Diseño (Gráfico Completo) - FOTO REPARADA V3
(
...
-- 21. Diseño (Pack) - FOTO REPARADA V3
(
...
-- 29. Diseño (UX/UI) - FOTO REPARADA V3
(
